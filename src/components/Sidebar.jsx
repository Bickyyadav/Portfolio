...
export default function Sidebar() {
  return (
    <aside className="w-64 h-screen bg-gray-100 p-6 fixed left-0 top-0 flex flex-col justify-between">
      {/* Profile Section */}
      <div>
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-col space-y-2 mt-2 gap-3">
            {social.map(social => (
              <a key={social.name} href={social.link} className="flex items-center space-x-2 text-gray-700 hover:text-blue-600 transition">
